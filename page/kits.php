...
<head>
    ...
    <link rel="stylesheet" href="../module/boostrap/css/bootstrap.min.css" crossorigin="anonymous"
    />
...
<body>
    <header>
        ...
        <div class="social-bar">
            <a href="https://www.facebook.com/Fdabycoficial" class="icon icon-facebook fa-brands fa-facebook"style="width: 45.6px;" target="_blank"></a>
            <a href="https://mobile.twitter.com/fdabyc" class="icon icon-twitter fa-brands fa-twitter"style="width: 45.6px;" target="_blank"></a>
            <a href="https://www.linkedin.com/in/fundaci%C3%B3n-dios-abre-brecha-y-camino-76a1a9250" class="icon fa-brands icon-linkedin2 fa-brands fa-linkedin"style="width: 45.6px;" target="_blank"></a>
            <a href="https://www.instagram.com/fundaciondabyc" class="icon icon-instagram fa-brands fa-instagram" style="width: 45.6px;" target="_blank"></a>
                ...
                <div class="row">
                    <div class="contenedor2">
                        <div class="caja">
                            ...
                            <img src="../assets/img/img_kits/img1.jpeg" alt="">
                            <div class="center">
                                <form action="viveres.html">
                        ...
                        <div class="caja">
                            ...
                            <img src="../assets/img/img_kits/img2.jpeg" alt="">
                            <div class="center">
                                <form action="proteina.html">
                                    <input type="submit" value="DONAR">
                                </form>
                            </div>
                        </div>
                        <div class="caja">
                            ...
                            <img src="../assets/img/img_kits/img3.jpeg" alt="">
                            <div class="center">
                        ...
                        <div class="caja">
                            ...
                            <img src="../assets/img/img_kits/img4.jpeg" alt="">
                            <div class="center">
                                <form action="higiene.html">
                                    <input type="submit" value="DONAR">
                                </form>
                            </div>
                        </div>
    ...
    <script src="../module/boostrap/js/bootstrap.bundle.js" crossorigin="anonymous"></script>
</body>
</html>