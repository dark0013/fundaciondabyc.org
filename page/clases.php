...
<body>
    <header>
        ...
        <div class="social-bar">
            <a href="https://www.facebook.com/Fdabycoficial" class="icon icon-facebook fa-brands fa-facebook"
                style="width: 45.6px;" target="_blank"></a>
            <a href="https://mobile.twitter.com/fdabyc" class="icon icon-twitter fa-brands fa-twitter"
                style="width: 45.6px;" target="_blank"></a>
            <a href="https://www.linkedin.com/in/fundaci%C3%B3n-dios-abre-brecha-y-camino-76a1a9250"
                class="icon fa-brands icon-linkedin2 fa-brands fa-linkedin" style="width: 45.6px;" target="_blank"></a>
            <a href="https://www.instagram.com/fundaciondabyc" class="icon icon-instagram fa-brands fa-instagram"
                style="width: 45.6px;" target="_blank"></a>
            ...
            <div class="container col-md-6">
                <div class="row">
                    <div class="justify-content-center"><br><br>
                        <h2 class="titulo">Formulario de Regreso a Clases</h2><br>
                        <div class="container" id="general">
                            ...
                            <h5 class="subtitulo">Lista de Utiles Escolares:</h5>
                            <div class="container">
                                <div class="row">
                                    <div class="form-group col-6">
                                        <label for="#">1 Resma de Hojas:</label>
                                        <input type="number" name="Hojas" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">Lapiz:</label>
                                        <input type="number" name="Lapiz" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">2 Cuad. Cuadro universitario:</label>
                                        <input type="number" name="cuad" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">Sacapuntas:</label>
                                        <input type="number" name="Sacapuntas" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">2 Cuad. Linea universitario:</label>
                                        <input type="number" name="papel" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">Borrador:</label>
                                        <input type="number" name="Borrador" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">1 Funda de Hojas de Cuadro:</label>
                                        <input type="number" name="funda" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">Pluma Azul:</label>
                                        <input type="number" name="azul" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">1 Funda de Hojas de Lineas:</label>
                                        <input type="number" name="funda" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">Pluma Negra:</label>
                                        <input type="number" name="Negra" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">Caja de lapices de colores:</label>
                                        <input type="number" name="colores" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">Pluma Roja:</label>
                                        <input type="number" name="Roja" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                    <div class="form-group col-6">
                                        <label for="#">Caja de Marcadores:</label>
                                        <input type="number" name="Marcadores" placeholder="cantidad" class="cantidad form-control">
                                    </div>
                                </div>
                            </div>    
            ...
            <div class="footer-up">
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 com-sm-12">
                        ...
                        <ul>
                            <li><a href="index.php">Inicio</a><a href="about.php">Nosotros</a><a
                                    href="contact.php">Contactanos</a></li>
                        </ul>
                    </div>
                    <!--<div class="col-lg-3 col-md-6 col-sm-12">
						<h5>Our Causes</h5>
